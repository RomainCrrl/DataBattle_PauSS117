...
<head>
    <meta charset="UTF-8">
    <title>Test your knowledge on Theme 2</title>
...
<body>
    ...
    <div class="main-content">
        <h2 class="p-2 text-center font-bold text-3xl">Test your knowledge on the 2nd theme</h2>
	...
	document.body.classList.toggle('dark-mode'); // Change 'dark' en 'dark-mode'
        ...
        function getQuestion() {
            fetch('http://localhost:5000/ask?theme=2&type=' + currentMode + "&_=" + new Date().getTime())
