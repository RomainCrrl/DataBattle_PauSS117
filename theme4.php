...
<head>
    <meta charset="UTF-8">
    <title>Test your knowledge on Theme 4</title>
...
<body>
    ...
    <div class="main-content">
        <h2 class="p-2 text-center font-bold text-3xl">Test your knowledge on the 4th theme</h2>
    ...
    <script>
        ...
        function getQuestion() {
            fetch('http://localhost:5000/ask?theme=4&type=' + currentMode + "&_=" + new Date().getTime())
